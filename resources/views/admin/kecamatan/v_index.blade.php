        ...
        <div class="card card-secondary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="/kecamatan/add" type="button" class="btn btn-primary btn-flat"><i
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-sm btn-flat btn-danger" data-toggle="modal"
                                        data-target="#delete{{ $data->id_kecamatan }}"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <a href="/kecamatan/delete/{{ $data->id_kecamatan }}" type="button"
