...
@section('content')
        ...
        <div class="card card-secondary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="/spesialis/add" type="button" class="btn btn-primary btn-flat"><i
                        ...
                        @foreach ($spesialis as $data)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/spesialis/edit/{{ $data->id_spesialis }}"
                                    ...
                                    <button class="btn btn-sm btn-flat btn-danger" data-toggle="modal"
                                        data-target="#delete{{ $data->id_spesialis }}"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
    ...
    <!-- modal-delete -->
    @foreach ($spesialis as $data)
        <div class="modal fade" id="delete{{ $data->id_spesialis }}">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    <div class="modal-header">
                        <h4 class="modal-title">{{ $data->spesialis }}</h4>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <a href="/spesialis/delete/{{ $data->id_spesialis }}" type="button"
