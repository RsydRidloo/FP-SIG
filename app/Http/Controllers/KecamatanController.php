...
class KecamatanController extends Controller
{
    ...
    public function insert()
    {
        Request()->validate(
            ...
            [
                'kecamatan.required' => 'Wajib Untuk Diisi !',
                'warna.required' => 'Wajib Untuk Diisi !',
                'geojson.required' => 'Wajib Untuk Diisi !',
            ]
        );
    ...
    public function update($id_kecamatan)
    {
        ...
        return redirect()->route('kecamatan')->with('pesan', 'Data berhasil Di Perbarui');
    }
